...
def main(sentiment):
    ...
    if sentiment == 'like':
        ...
        while True:
            try:
                like_location = pyautogui.locateCenterOnScreen('like.png', confidence = 0.9)
                time.sleep(3)
                ...
                if sentiment == 'celebrate':
                    celebrate = pyautogui.locateCenterOnScreen('celebrate.png')
                    pyautogui.moveTo(celebrate)
                    pyautogui.click()

                elif sentiment == 'support':
                    support = pyautogui.locateCenterOnScreen('support.png')
                    pyautogui.moveTo(support)
                    pyautogui.click()

                elif sentiment == 'love':
                    love = pyautogui.locateCenterOnScreen('love.png')
                    pyautogui.moveTo(love)
                    pyautogui.click()

                elif sentiment == 'insightful':
                    insightful = pyautogui.locateCenterOnScreen('insightful.png')
                    pyautogui.moveTo(insightful)
                    pyautogui.click()

                elif sentiment == 'funny':
                    funny = pyautogui.locateCenterOnScreen('funny.png')
